...
enum class UiAccentPreset(
    ...
    VIOLET(
        id = "violet",
        title = "Виолет",
        accentLight = 0xFF7F57D9.toInt(),
        accentDark = 0xFFA786FF.toInt(),
        altLight = 0xFF4C8BF5.toInt(),
        altDark = 0xFF76ACFF.toInt(),
    ),
    RUBY(
        id = "ruby",
        title = "Рубин",
        accentLight = 0xFFC94862.toInt(),
        accentDark = 0xFFFF6C89.toInt(),
        altLight = 0xFFEB7B34.toInt(),
        altDark = 0xFFFFA05D.toInt(),
    ),
    ICEBERG(
        id = "iceberg",
        title = "Айсберг",
        accentLight = 0xFF1F8FB7.toInt(),
        accentDark = 0xFF57C5ED.toInt(),
        altLight = 0xFF3BC6C0.toInt(),
        altDark = 0xFF73E7DD.toInt(),
    ),
    GRAPHITE(
        id = "graphite",
        title = "Графит",
        accentLight = 0xFF55606E.toInt(),
        accentDark = 0xFF98A7B7.toInt(),
        altLight = 0xFF2C9A86.toInt(),
        altDark = 0xFF58C9B2.toInt(),
    ),
    STEEL(
        id = "steel",
        title = "Сталь",
